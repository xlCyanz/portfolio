...
export const DATA = {
  ...
  description:
    "A passionate frontend developer. I consider myself a responsible, communicative person with the initiative to solve problems and achieve my personal goals.",
  summary: "",
  avatarUrl: "/me.png",
  skills: ["React", "Docker", "Node.js", "Postgres", "Typescript", "GraphQL", "TailwindCSS"],
